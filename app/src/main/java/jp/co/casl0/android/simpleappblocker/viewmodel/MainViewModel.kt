...
package jp.co.casl0.android.simpleappblocker.viewmodel
...
@Parcelize
data class MainUiState(val filtersEnabled: Boolean = false) : Parcelable
...
constructor(
    ...
    private val _uiState =
        MutableStateFlow(
            savedStateHandle.get<MainUiState>(key = KEY_UI_STATE)
                ?: MainUiState())
